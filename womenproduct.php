        ...
        <a class="logo"> <img src="images/logo.jpg">  </a>
            ...
            <nav class="header-left">
                <a  href="index.php">Home</a>
                    <div class="dropdown">
                <a class="active" href="womenproduct.php">Women</a>
                    <div class="dropdown-options">
                      <a href="menproduct.php"> Men </a>
                      <a href="productoffer.php"> Offers</a>
                    </div>
                    </div>
...
<div class="product"> Women Products</div>
 
<div id="product-grid">
	
            <?php
            $product_array = $db_handle->runQuery("SELECT * FROM womenproducts ORDER BY id ASC");
